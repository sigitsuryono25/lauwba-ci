...
<div class="demo">
    <div class="container-fluid">
        <div class="row">
            ...
            <!--              <img src="/assets/img/icn/reguler-online-lauwba.png"></img>-->
            <!--            <div class="price-value font-weight-bold">KELAS REGULER ONLINE </s></div>-->

            <!--        </div>-->
            <!--        <b>-->
            <!--            <font color="red">Rp. <del>-->
            <!--                    <?= $this->etc->rps($harga->biaya_reg_online_coret)?>-->
            <!--                </del></font><br>-->
            <!--            <font color="#ff9624">Rp.-->
            <!--                <?= $this->etc->rps($harga->biaya_reg_online)?>-->
            <!--            </font>-->
                        <!--<font color="red"> Rp.<s> 3.000.000 </s><br></font>-->
                        <!--<font color=#ff9624>Rp.899.000 </font>-->
            <!--        </b>-->
            ...
            <!--                <li style="line-height: 20px;" class="mt-3"><b>Jadwal :</b><br><a href="javascript:void(0)"-->
            <!--                        onclick="parent.parentJadwal('reguler-online')">Klik Disini</a>-->
            <!--                </li>-->
            ...
            <!--                <br>-->
            <!--                  <br>-->
            <!--                                                                     <img src="/img/garansi.jpg"><br>-->

                                    
            <!--                                                        <font color="blue"><b>GARANSI :<br></b> GRATIS Mengulang Sampai Bisa! </del></font><br>-->
                            <!--<font color="red"><b>GARANSI :<br></b> GARTIS Mengulang Sampai Bisa</del></font><br>-->
            <!--            </ul>-->
            <!--        </div>-->
            ...
            <div class="col-md-4 col-sm-6 mt-4">
                <div class="pricingTable indigo">
                    <div class="pricingTable-header ">
                            <img src="/assets/img/icn/presentation1.png"></img>
                        <div class="price-value font-weight-bold"> REGULER CLASS </div>

                    </div>
                    <b>
                        <font color="red">Rp. <del>
                                <?= $this->etc->rps($harga->biaya_coret)?> /Peserta
                            </del></font><br>
                    </b>
                    
                    <b class="text-dark">Pelaksanaan :</b><br>
                    <font color="black">
                        Yogyakarta<br>
                        <b>Rp.
                            <?= $this->etc->rps($harga->biaya)?> /Peserta
                        </b>
                    </font><br>
                    <font color="indigo">
                        Luar Yogyakarta<br>
                        <b>Rp.
                            <?= $this->etc->rps($harga->biaya_luar_kota)?> /Peserta
                        </b>
                    </font>
                    ...
                    <div class="pricing-content mt-3">
                        <ul>
                            ...
                            <li style="line-height: 20px;" class="mt-3"><b>Durasi :</b><br>4 Hari Full Day</li>
                            <li style="line-height: 20px;" class="mt-3"><b>Jadwal :</b><br><a href="javascript:void(0)"
                                    onclick="parent.parentJadwal('reguler-offline')">Klik Disini</a></li>
                            <li style="line-height: 20px;" class="mt-3"><b>Jumlah Peserta :</b> <br>2-7
                                Peserta/Kls</li>
                            <li style="line-height: 20px;" class="mt-3"><b>Materi/Silabus :</b><br>Mengikuti
                                Silabus Kami</li>
                                
                            <!--                                <img src="/assets/img/icn/hotel-lauwba.png"><br>-->
            ...
            <?php $hargaPerorang = json_decode($harga->biaya_in_house_per_person)?>
            <div class="col-md-4 col-sm-6 mt-4">
                <div class="pricingTable teal">
                    <div class="pricingTable-header">
                        <i class="fa fa-briefcase"></i>
                        <div class="price-value font-weight-bold"> CORPORATE TRAINING
                        </div>

                    </div>
                        
                           <span class="text-dark"> <i>Pelatihan Khusus Corporate/Instansi <br>Untuk
                                Pengembangan skill SDM Perkantoran</i>  </span>
                            <p>
                        <font color="red">Rp. <del>
                                <?= $this->etc->rps($harga->biaya_inhouse_coret)?> /Peserta
                            </del></font><br>
                          <span style="color: black"> 1-2 Peserta</span>  <br>
                        <font color="#0399be">Rp. <?= $this->etc->rps($hargaPerorang->biaya_1_2)?>/Peserta <br> </font>
                            <span style="color: black"> 3-5 Peserta</span>  <br>
                        <font color="#0399be">Rp. <?= $this->etc->rps($hargaPerorang->biaya_3_5)?>/Peserta <br> </font>
                         <span style="color: black"> 6 Peserta atau lebih</span>  <br>
                        <font color="#0399be">Rp.<?= $this->etc->rps($hargaPerorang->biaya_lebih_6)?>/Peserta <br> </font> </b>

                            <?
                            // = $this->etc->rps($harga->biaya_inhouse)
                            ?>
                        </font>
                    <div class="pricing-content mt-3">
                        <ul>
                                ...
                                <li style="line-height: 20px;" class="mt-3"><b>Durasi :</b><br>3 Hari Full Day/By Request
                                </li>
                                <li style="line-height: 20px;" class="mt-3"><b>Jadwal :</b><br><a
                                ...
                                <li style="line-height: 20px;" class="mt-3"><b>Materi/Silabus :</b><br>Sesuai
                                    Silabus kami/By Request <br><a
                                        onclick="parent.openUrl('https://lauwba.com/in-house-training-27.html')"
                                        href="javascript:void(0)"> Selengkapnya KLIK DISINI</a></li>
            ...
            <div class="col-md-4 col-sm-6 mt-4" style="transform: scale(1.05); z-index: 1;">
                <div class="pricingTable green">
                    ...
                    <img src="/assets/img/icn/private-class-online2.png"></img>
                        <div class="price-value font-weight-bold text-white">PRIVATE CLASS &nbsp; ONLINE</div>

                    </div>
                    <b>
                        <font color="red">Rp. <del>
                                <?= $this->etc->rps($harga->biaya_private_online_coret)?> /Peserta
                            </del></font><br>
                        <font color="green">Rp.
                            <?= $this->etc->rps($harga->biaya_private_online)?> /Peserta
                        </font>
                    </b>
                    <div class="pricing-content mt-3">
                        <ul>
                            <li style="line-height: 20px;"><b>Pelaksanaan :</b><br>Via Zoom/Google Meet</li>
                            <li style="line-height: 20px;" class="mt-3"><b>Durasi</b><br>-+ 1 Bulan/sampai
                                materi selesai dan sudah paham</li>
                            <li style="line-height: 20px;" class="mt-3"><b>Jadwal : </b><br><a
                                    href="javascript:void(0)">By
                                    Request</a></li>
                    ...
                    <div class="pricingTable-signup">
                        <a href="javascript:void(0)" class="bg-success" onclick="parent.parentRegister()">Daftar
                            Sekarang</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-4 col-sm-6 mt-4" style="transform: scale(1.05); z-index: 2;">
                <div class="pricingTable pink">
                    ...
                    <div class="pricingTable-header">
                        <img src="/assets/img/icn/bootcamp4-lauwba.png"></img>
                        <div class="price-value font-weight-bold"> INKUBATOR CLASS<br>(Bootcamp 2-6 Bulan) </div>

                    </div>
                    <b>
                        <font color="red">Rp. <del>
                                <?= $this->etc->rps($harga->biaya_incubator_coret)?> / Bulan
                            </del></font><br>
                        <font color="#F5005">Rp.
                            <?= $this->etc->rps($harga->biaya_incubator)?> /Bulan
                        </font>
                    </b>
                    <div class="pricing-content mt-3">
                        <ul>
                                    <li style="line-height: 20px;">Kelas khusus untuk persiapan <br>memasuki <b>Dunia
                                            Kerja atau yang ingin mendalami dari Nol sampai Tuntas</b></li><br>
                            <li style="line-height: 20px;"><b>Pelaksanaan :</b><br>Bisa Request Online atau Offline
                                <br>di kantor kami
                                (Yogyakarta)</li>
                            <li style="line-height: 20px;" class="mt-3"><b>Durasi :</b><br>2-6 Bulan </li>
                            <li style="line-height: 20px;" class="mt-3"><b>Jadwal :</b><br><a
                                    href="javascript:void(0)">Kelas Baru Buka Setiap Hari </br></a></li>
                            ...
                            <li style="line-height: 20px;" class="mt-3"><b>Materi/Silabus :</b><br>Silabus Basic
                                + Lanjut + Project 
                                    ...
                                    <div class="pricingTable-signup">
                        <a href="javascript:void(0)" onclick="parent.openUrl('https://lauwba.com/incubator-class-android-26.html')">INFO Selengkapnya KLIK DISINI</a>
                    </div>
                            <img src="/assets/img/icn/hotel-lauwba.png"><br>
                            <font color="blue"><b>GRATIS<br> </b>Penginapan selama  pelatihan</del></font><br> </a>
            ...
            <div class="col-md-4 col-sm-6 mt-4">
                <div class="pricingTable red">
                    <div class="pricingTable-header">
                        <img src="/assets/img/icn/private-class.png"></img>

                        <div class="price-value font-weight-bold"> PRIVATE CLASS OFFLINE</div>
                 ...
                 <b class="text-dark">Pelaksanaan: </b><br>
                    <font color="black">
                        ...
                        <b>
                        <font color="red">Rp. <del>
                                <?= $this->etc->rps($harga->biaya_private_coret)?> /Peserta
                            </del></font><br>
                        <font color="black">Rp.
                            <?= $this->etc->rps($harga->biaya_private)?> /Peserta
                        </font>
                    </b>
                    </font><br>
                    <font color="black">
                        ...
                        <b>
                        <font color="red">Rp. <del>
                             <?= $this->etc->rps($harga->biaya_private_off_luar_kota)?> /Peserta
                               
                            </del></font><br>
                        <font color="black">Rp.
                            <?= $this->etc->rps($harga->biaya_private_off_luar_kota_coret)?> /Peserta
                        </font>
                    </b>
                    </font>
            ...
            <div class="col-md-4 col-sm-6 mt-4">
                <div class="pricingTable blue">
                    ...
                    <font color="blue"><b>Harga :</b><br>Menyesuaikan Tingkat <br>Kesulitan Project </font></b>
                    <div class="pricing-content mt-3">
                        <ul>
            ...
            <!--        <div class="pricingTable-header">-->
            <!--            <i class="fa fa-cube"></i>-->
            <!--            <div class="price-value font-weight-bold"> WEBINAR/WORKSHOP</div>-->
            <!--        </div>-->
            <!--        <font color="green"><b>Harga :</b><br>Hub Kami</font></b>-->
            <!--        <div class="pricing-content mt-3">-->
            <!--            <ul>-->
            <!--                <li style="line-height: 20px;"><b>Pelaksanaan :</b><br>Offline/Online</li>-->
            <!--                <li style="line-height: 20px;" class="mt-3"><b>Durasi :</b><br>Fleksibel</li>-->
