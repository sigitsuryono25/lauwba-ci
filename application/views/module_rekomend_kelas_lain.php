...
<div class="container">
    <div class="row px-4 ">
        <div class="col-md-12">
                ...
                <h2 class="h4 ml-5 pl-5" id="titleborder"><span>Rekomendasi Kelas Lainnya</span></h2>
            </div>
        </div>
        ...
        <div class="col-md-12 d-md-none d-block">
            ...
            <div class="newTitle1Mobile" style=" position: absolute;top: 50%;left: 50%;transform: translate(-50%, -50%);">
                <h2 class="h5 ml-5 pl-4 " id="titleborder"><span>&nbsp;&nbsp;&nbsp; Rekomendasi Kelas Lainnya</span></h2>
            </div>
        </div>
...
<<<<<<< HEAD:application/views/module_rekomend_kelas_lain.php
...
=======
                <div class="row mb-3 px-3" onclick="location.href = '<?php echo site_url($k->routes) ?>'" style="cursor: pointer">
                    <div class="py-2 col-md-12 light-shadow">
                        <div class="row">
>>>>>>> 9caa20c15c70040dacffd45d99145e72d46c2d56:application/views/software-dev.php
                            <div class="text-center col-md-2 d-block align-self-center justify-content-center">
                                <img class="lazyload img-fluid" src="<?php echo base_url()?>foto_berita/<?php echo $k->gambar?>" height="84" width="140">
                            </div>
                            <div class="col-md-10">
