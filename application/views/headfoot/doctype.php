...
<html lang="id">
    <head>
        ...
        <script  src="<?php echo base_url('assets/highslide/') ?>highslide-with-gallery.min.js" type="text/javascript"></script>
        
        
        <!--COUNTDOWN-->
		<script src="<?php echo base_url('assets/js/') ?>countdown.jquery.js"></script>
