...
<div class="wrapper-page">
    ...
    <?php $ddataPorto = $this->db->query("SELECT * FROM gallery join album on album.id_album=gallery.id_album where gallery.id_album in ('26', '18')  order by seq asc LIMIT 15")->result()?>
    
    
    <h4 class="text-center">Portofolio Web & Desktop Apps</h4>
    <div class="row">
