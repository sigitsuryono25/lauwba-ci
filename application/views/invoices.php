...
<title><?php echo $detail->nama_lengkap?> | PT Lauwba Techno Indonesia</title>
</head>
<style>
@page {
    size: A4 portrait;
    margin: 10mm !important; /* jangan 0, biar align normal */
}
...
@media print {
    ...
    .invoice-wrapper {
        width: 100% !important;      /* A4 safe width */
...
<body>
    <div class="invoice-wrapper canvas_div_pdf">
        <div class="container p-2">
            ...
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <!--<img src="<?php //= base_url('assets/img/header-rekening.png')?>" class="img img-fluid w-100"/><br>-->
                    <?php foreach($rekening as $rr){?>
                        <img src="<?= $rr->fullpath?>" alt="<?= $rr->filename?>" onclick="copyRekening('<?= $rr->nomor_rekening?>')"
                            class="img img-fluid w-100"/><br>
                    <?php }?>
           ...
           if($detail->pilihan_kelas == 'reg'){
               ...
               $coret = ($detail->private_kota_pelaksanaan == 'luar-yogya') ? $detail->biaya_private_off_luar_kota : $detail->biaya_private_coret;
           ...
           ?>
            ...
            <div class="text-center">
                <p>
                    <span  class="font-weight-bold h5">Legalitas Perusahaan</span><br>
                    <span>SKT.KEMENKUMHAM RI <br>NO AHU-0022789.AH.01.01</span><br> 
                    <span>Nomor NPWP : 91.302.590.4-541.000</span> <br>
                    <span>PT. Lauwba Techno Indonesia</span>
                </p>
                    <footer style="background-color: rgb(197, 197, 197);" class="p-2">
