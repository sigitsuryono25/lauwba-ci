    ...
    <body>
        ...
        <div class="mt-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="" contenteditable="true">Client<br></h3><img class="img-fluid d-block" src="assets/img/CLIENT-kursus-Pembuatan-website-android-makassar-jogja-lauwba.jpg">
                    </div>
                </div>
            </div>
        </div>
    ...
    <body>
                ...
                <div class="collapse navbar-collapse" id="navbar4">
                    <ul class="navbar-nav  ml-auto">
                        ...
                        <li class="nav-item dropdown "> 
                            <a class="nav-link dropdown-toggle " data-toggle="dropdown" href="javascript:void(0)" aria-haspopup="true" aria-expanded="true" id="profil">PROFIL</a>
                        ...
                        <li class="nav-item dropdown"> 
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="">Training/Kursus Android</a>
                                <a class="dropdown-item" href="">Training/Kursus Website</a>
                                <a class="dropdown-item" href="">Training/Kursus Digital Marketing</a>
                                <a class="dropdown-item" href="">Lain-Lain</a>
                            </div>
                        </li>
                        <li class="nav-item"> <a class="nav-link" id="kontak" href="#">KONTAK</a> </li>
        ...
        <div class="mt-3">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h3 class="" contenteditable="true">Client<br></h3><img class="img-fluid d-block" src="https://lauwba.com/img/CLIENT-kursus-Pembuatan-website-android-makassar-jogja-lauwba.jpg">
                    </div>
                </div>
            </div>
        </div>
